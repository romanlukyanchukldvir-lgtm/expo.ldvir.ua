...
- наявність такого телефону в цільовій воронці KeyCRM перед створенням нового ліда;
...
Якщо такий телефон уже є в цільовій воронці KeyCRM, сайт не створює дубль. Якщо телефон є тільки в клієнтах/покупцях CRM, але в цій воронці картки немає, сайт створить новий лід. Користувач бачить success-повідомлення, але Meta Pixel `LandingFormSubmit` не відправляється, якщо новий лід у CRM не створювався.
